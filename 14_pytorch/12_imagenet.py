...
def main():
    ...
    train_dataset = datasets.ImageFolder('/gs/fs/datasets/academic/ILSVRC2012_img_train',
                                         transforms.Compose([
    ...
    val_dataset = datasets.ImageFolder('/gs/fs/datasets/academic/ILSVRC2012_img_val',
                                         transforms.Compose([
